  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src={logo} alt="Logoipsum" style={{ width: "50px" }} />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/share/1C8CM5XsKy/?mibextid=qi2Omg"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.instagram.com/whoavikashyap.73?igsh=Y2hiN252MXZuYWZt"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/abhigyan-kumar-2aa944234?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Abhigyan</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
      ...
      <div className="footer--copyright">
        <p style={{ textAlign: "center", fontSize: "14px", marginTop: "1rem" }}>
          © 2025 Abhigyan Kumar. All rights reserved.
        </p>
      </div>
    </footer>
  );
